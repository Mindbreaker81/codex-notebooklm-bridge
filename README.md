  ...
  "notebooks": [
    {
      ...
      "description": "Research notebook about SymptomAI.",
      "topics": ["health-ai", "symptom-assessment"],
      "use_cases": ["answer questions about SymptomAI evaluation"]
    }
  ],
  "active_notebook_id": "symptomai-paper"
}
```
...
python .agents/skills/notebooklm/scripts/library.py add \
  ...
  --use-case "answer questions about SymptomAI evaluation"
```

Actualizar:

```bash
python .agents/skills/notebooklm/scripts/library.py update symptomai-paper \
...
```bash
python .agents/skills/notebooklm/scripts/library.py set-active symptomai-paper
...
```text
Notebook: SymptomAI: Conversational AI for Everyday Symptom Assessment
Sources cited: 2605.04012.pdf

Answer:
- SymptomAI was deployed through Fitbit for everyday symptom assessment. [1, 2]
- The study compared SymptomAI's differential diagnoses against clinicians. [3, 4]
...
- Titulo extraido: `SymptomAI: Conversational AI for Everyday Symptom Assessment`.
- Fuente citada: `2605.04012.pdf`.
